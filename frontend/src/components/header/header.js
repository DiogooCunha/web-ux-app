        ...
        Promise.all([
          ...
          nav.items = [
            ...
            },
            {
              label: "Repositories",
              href: "/repositories",
              icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M18 16v-5a6 6 0 0 0-5-5.91V4a1 1 0 0 0-2 0v1.09A6 6 0 0 0 6 11v5l-2 2v1h16v-1l-2-2zm-6 4a2 2 0 0 0 2-2h-4a2 2 0 0 0 2 2z"/></svg>`,
            },
            {
              label: "Issues",
              href: "/issues",
